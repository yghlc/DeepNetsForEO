...
# In[4]:
    ...
    imgs = [io.imread(BASE_FOLDER + 'top/UAV_DOM_Eboling_0.48m_{}.tif'.format(l)) for l in infer_ids]
    ...
    gts = [io.imread(BASE_FOLDER + 'gts_for_participants/raster_class_version_gps_rtk_3_fix_{}.tif'.format(l)) for l in infer_ids]
